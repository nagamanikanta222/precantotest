$(function() {
    ...
    // based on prepared DOM, initialize echarts instance
        ...
        var poleChart1 = echarts.init(document.getElementById('pole-chart1'));
        // Data style
        var dataStyle = {
            normal: {
                label: {show: false},
    ...
    poleChart1.setOption(option);

    var poleChart2 = echarts.init(document.getElementById('pole-chart2'));
            // Data style
            var dataStyle = {
                normal: {
                    label: {show: false},
