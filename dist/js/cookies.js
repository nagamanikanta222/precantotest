	...
	add these code at the end of login.html
	 ...
	 <script>
	    //  cookie based authentication starts here 
	     ...
	     function setCookies(){
	        // =============================================================
	        // setCookie('cookiename','cookievalue','expirationtimeindays')
	        // =============================================================
	        setCookie('username',document.getElementById('username').value,7)
	        setCookie('password',document.getElementById('password').value,7)
	        // window.location.href="C:/Users/PraveenKumarNayakudi/Desktop/PrecantoClone_Feb1/precantotest/index.html"
	        // window.location.href="https://kalyanpre.github.io/precantotest/index.html"
